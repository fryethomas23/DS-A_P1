...
print('Output of get(9): ', our_cache.get(9))
# returns -1 because 9 is not present
# in the cache
...
print('Output of get(3): ', our_cache.get(3))
# returns -1 because the cache reached
...
print('Output of get(3): ', our_cache2.get(3))
# returns -1 because the cache reached
# it's capacity and 3 was the least
# recently used entry.

print('Output of get(1): ', our_cache2.get(1))
# returns 1 because when 1 was gotten
...
print('Output of get(6): ', our_cache3.get(6))
# returns 6 because it was successful
# added to the linked list after
# reaching capacity

print('Output of get(1): ', our_cache3.get(1))
# returns -1 because 1 is not present
# in the cache
# print(our_cache3)
...
print('Output of get(1): ', our_cache4.get(1))
# returns -1 because the cache has a
# max capacity of 0 or less
# print(our_cache4)
...
print('Output of get(1): ', our_cache5.get(1))
# returns -1 because the cache has a
# max capacity of 0 or less
# print(our_cache4)
